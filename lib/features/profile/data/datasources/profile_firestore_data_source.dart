...
class ProfileFirestoreDataSource {
  ProfileFirestoreDataSource({required FirebaseFirestore firestore})
  ...
  Future<DocumentSnapshot<Map<String, dynamic>>> get(String uid) =>
      _users.doc(uid).get();

  Future<void> set(String uid, Map<String, dynamic> data) =>
